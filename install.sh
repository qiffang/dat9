...
main() {
  ...
  printf "\n"
  printf "  Try:\n"
  printf "    ${DIM}\$${RESET} dat9 ls :/                             ${DIM}# list files${RESET}\n"
  printf "    ${DIM}\$${RESET} dat9 cp ./file.txt :/data/file.txt     ${DIM}# upload a file${RESET}\n"
  printf "    ${DIM}\$${RESET} dat9 sql \"SELECT * FROM file_nodes\"    ${DIM}# query metadata${RESET}\n"
  printf "    ${DIM}\$${RESET} dat9 sh                                ${DIM}# interactive shell${RESET}\n"
  printf "\n"
  printf "  Environment:\n"
